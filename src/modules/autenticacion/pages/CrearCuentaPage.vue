						...
						<b-card-text>
							...
							<b-form @submit.prevent="EnviarDatosCrearUsuario">
                                <b-row cols="1" cols-lg="2" cols-xl="3">
                                    <b-col class="form-datos-personales">
                                        ...
                                        >
                                            ...
                                            >
                                                <div v-if="!$v.datosUsuario.nombre.required">
                                                    Debe ingresar el su nombre
                                                </div>
                                                <div v-if="!$v.datosUsuario.nombre.minLength">
                                                    Nombre muy corto
                                                </div>
                                                <div v-if="!$v.datosUsuario.nombre.maxLength">
                                        ...
                                        >
                                            <b-form-input
                                                id="input-2"
                                                v-model="datosUsuario.apellidoPaterno"
                                                class="input-formulario"
                                                type="text"
                                                :state="EstadoValidacion('apellidoPaterno')"
                                                placeholder="Apellido Paterno"
                                            ></b-form-input>
                                            <b-form-invalid-feedback
                                                id="input-2-live-feedback"
                                            >
                                                <div v-if="!$v.datosUsuario.apellidoPaterno.required">
                                                    Debe ingresar su apellido paterno
                                                </div>
                                                <div v-if="!$v.datosUsuario.apellidoPaterno.minLength">
                                                    Apellido paterno muy corto
                                                </div>
                                                <div v-if="!$v.datosUsuario.apellidoPaterno.maxLength">
                                                    Apellido paterno demasiado largo
                                                </div>
                                            </b-form-invalid-feedback>
                                        </b-form-group>
                                        ...
                                        >
                                            <b-form-input
                                                id="input-3"
                                                v-model="datosUsuario.apellidoMaterno"
                                                class="input-formulario"
                                                type="text"
                                                :state="EstadoValidacion('apellidoMaterno')"
                                                placeholder="Apellido Materno"
                                            ></b-form-input>
                                            <b-form-invalid-feedback
                                                id="input-3-live-feedback"
                                            >
                                                <div v-if="!$v.datosUsuario.apellidoMaterno.required">
                                                    Debe ingresar su apellido materno
                                                </div>
                                                <div v-if="!$v.datosUsuario.apellidoMaterno.minLength">
                                                    Apellido materno muy corto
                                                </div>
                                                <div v-if="!$v.datosUsuario.apellidoMaterno.maxLength">
                                                    Apellido materno demasiado largo
                                                </div>
                                            </b-form-invalid-feedback>
                                        </b-form-group>
                                        ...
                                        >
                                            ...
                                            >
                                                <div v-if="!$v.datosUsuario.dni.required">
                                                    Debe ingresar el número de DNI
                                                </div>
                                                <div v-if="!$v.datosUsuario.dni.minLength">
                                                    Número de DNI muy corto
                                                </div>
                                                <div v-if="!$v.datosUsuario.dni.maxLength">
                                        ...
                                        >
                                            <b-form-datepicker 
                                                ...
                                                :state="EstadoValidacion('fechaNacimiento')"
                                                min="1900-01-01" 
                                                :max="fechaMaxima"
                                            ...
                                            >
                                                <div v-if="!$v.datosUsuario.fechaNacimiento.required">
	...
	methods: {
		...
		EnviarDatosCrearUsuario()
		{
			...
			{ 
                ...
                axios.post('/api/crear-usuario', usuario)
                    .then((respuesta) => 
                    {
                        let data = respuesta.data
